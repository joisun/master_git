...
<template>
  <div>
    <el-dialog :title="title" :visible.sync="pictureDialog" top="5%" class="picture__global" :modal="modal">
      <div class="picture__show" v-if="pictureDialog">
        <el-carousel :indicator-position="indicatorPosition" :autoplay="false"
          height="75vh" :arrow="arrowWay" ref='carousel' :initial-index="index"
          @change="changeIndex">
