...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/international/carrier-manage/carrier-list",
        name: "international-carrier-list",
        component: LadyLiberty,
      },
      {
      ...
      {
        path: "/international/card-manage/profile-list",
        name: "international-profile-list",
        component: LadyLiberty,
      },
      // 充值申请
      {
      ...
      {
        path: "/international/version-manage/software",
        name: "international-version-manage-software",
        component: LadyLiberty,
      },
    ],
  },
