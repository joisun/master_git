 ...
 * @LastEditTime: 2021-02-26 15:35:50
-->
<template>
  <el-dialog
    :visible="visible"
...
<script>
  export default {
    ...
    methods: {
      onDownloadTemplate() {
        window.open('https://simboss-public.oss-cn-hangzhou.aliyuncs.com/template/commission/financial_template.xlsx')
      },
      async onSubmit() {
        const params = {
        ...
        const rst = await this.jaxLib.salesComission.import(params)
        if (rst.success) {
