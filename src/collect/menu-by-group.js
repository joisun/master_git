const serviceDep = [
  ...
  },
  {
    ...
    children: [
      ...
      // { name: '万佳安套餐重置', link: 'package-reset' }
    ]
  },
...
const supplyChainDep = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: '库存查看和预定',
        link: 'inventory-reservation-list'
      }
    ]
  },
  {
  ...
  },
  {
    name: '合规',
    children: [
      { name: '合规变更管理', link: 'ext-whitelist' },
      {
        name: '人联网黑名单',
        complex: [
          {
            name: '移动',
            link: 'human-connect-blacklist-list',
            params: { carrier: 'cmcc' }
          },
          {
            name: '联通',
      ...
      },
      {
        name: '流量预警',
        complex: [
          { name: '告警列表', link: 'flow-warning-list' },
          { name: '下载处理记录', link: 'flow-warning-downloads' }
        ]
      }
    ]
  },
...
const operationDep = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: '首单查询',
        complex: [
          { name: '卡平台', link: 'first-order-card' },
          { name: '设备平台', link: 'first-order-cpe' }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      { name: '合规变更管理', link: 'ext-whitelist' },
      { name: '运营商账号匹配', link: 'carrier-account-matching' },
      {
        name: '流量预警',
        complex: [
          { name: '告警列表', link: 'flow-warning-list' },
  ...
  {
    name: '国际卡',
    children: [{ name: '报价管理', link: 'international-price-list' }]
  }
]
const salesDep = [
  {
  ...
  {
    name: '合规',
    children: [{ name: '合规变更管理', link: 'ext-whitelist' }]
  },
  {
    name: '其他',
    children: [
...
export { salesDep, supplyChainDep, operationDep, serviceDep, HrDep, marketingDep }
